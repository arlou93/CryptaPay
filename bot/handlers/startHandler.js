...
const welcomeMessage = messageCreator([
  ...
  {
    title: "🚀 *Отправляйте и получайте USDT* без сложных адресов и лишних действий. Просто укажи @username получателя, и перевод будет выполнен в *самой выгодной сети с минимальной комиссией*",
  },
  {
